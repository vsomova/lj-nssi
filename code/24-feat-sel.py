...
def write_report(N_features):
    ...
    report += apply_ML.eval_norm_freq(new_df1) # get a report for ML for new df
    ...
    report += apply_ML.eval_norm_pres(new_df2)  # get a report for ML for new df
    ...
    report += apply_ML.eval_norm_med(new_df3)  # get a report for ML for new df
